...
public final class TwoDeadWheelLocalizer implements Localizer {
    public static class Params {
        public double parYTicks = -2630.9031840191615; // y position of the parallel encoder (in tick units)
        public double perpXTicks = -2183.097965097368; // x position of the perpendicular encoder (in tick units)
    }
