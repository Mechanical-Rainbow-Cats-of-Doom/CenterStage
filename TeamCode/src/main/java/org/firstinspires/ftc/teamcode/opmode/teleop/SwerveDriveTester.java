...
import org.firstinspires.ftc.teamcode.tool.StupidSandersHanger;
...
public class SwerveDriveTester extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        final StupidSandersHanger stupidSandersHanger = new StupidSandersHanger(hardwareMap, () -> driver1.getButton(GamepadKeys.Button.X));
        waitForStart();
        while (opModeIsActive()) {
            stupidSandersHanger.periodic();
